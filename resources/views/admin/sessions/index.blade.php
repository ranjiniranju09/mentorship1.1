...
{ data: 'id', name: 'id' },
{ data: 'modulename_name', name: 'modulename.name' },
{ data: 'mentorname_name', name: 'mentorname.name' },
{ data: 'menteename_name', name: 'menteename.name' },
{ data: 'sessiondatetime', name: 'sessiondatetime' },
{ data: 'sessionlink', name: 'sessionlink' },
{ data: 'session_title', name: 'session_title' },
{ data: 'session_duration_minutes', name: 'session_duration_minutes' },

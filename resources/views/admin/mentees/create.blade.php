...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.mentees.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('interestedskills') ? 'is-invalid' : '' }}" type="text" name="interestedskills" id="interestedskills" value="{{ old('interestedskills', '') }}" required>

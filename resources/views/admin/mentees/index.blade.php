...
@can('mentee_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.mentees.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Mentee">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.mentee.fields.skills') }}
                    </th>
                    <th>
...
@can('mentee_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.mentees.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.mentees.index') }}",
    columns: [
...
{ data: 'dob', name: 'dob' },
{ data: 'skilss', name: 'skilss' },
{ data: 'interestedskills', name: 'interestedskills' },
{ data: 'languagesspoken', name: 'languagesspokens.langname' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Mentee').DataTable(dtOverrideGlobals);
